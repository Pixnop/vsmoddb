<div id="cmt-{$comment['commentId']}" class="editbox comment{if $comment['deleted']} deleted{/if}{if $comment['responseTo'] !== $comment['commentId']} rsp rsp-{$comment['responseDepth']}{/if}" data-order="{$i}" data-stamp="{strtotime($comment['created'])}" data-cldn="{$comment['children']}" data-d="{$comment['responseDepth']}">
	<div class="title">
